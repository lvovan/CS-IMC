...
6. Pour vérifier que les messages ont bien été receptionnés par l'Event Hub, depuis le [portail Azure](https://portal.azure.com) sélectionner le namespace cible puis l'outil Data Explorer, View events
<br />
